...
<head>
    <meta charset="utf-8" />
    <title>Log In | Result Processing System </title>
                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div class="col-lg-6 p-4">
                                    ...
                                    <form method="POST" action="{{ url('sigin') }}" class="authentication-form">
                                    @csrf
                                        <div class="mb-3">
                                ...
                                <div class="col-lg-6 d-none d-md-inline-block">
                                    <div class="auth-page-sidebar">
                                        ...
                                        <div class="auth-user-testimonial">
                                            <p class="fs-24 fw-bold text-white mb-1">Welcome</p>
                                            <p class="lead">Automatic Result Processing System</p>
                                            <p>- Admin User</p>
                                        </div>
                                    </div>
                                </div>
